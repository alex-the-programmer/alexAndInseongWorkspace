...
export async function resolveActiveProductId(prisma, productId) {
    let id = productId;
 ...
 */
export default async function executeProductMerge(prisma, params) {
    ...
    if (!secondary)
        throw new Error(`Secondary product not found: ${secondaryProductId}`);
...
//# sourceMappingURL=mergeProduct.js.map