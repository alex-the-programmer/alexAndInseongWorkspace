import { getDedupSellers, OLIVE_YOUNG_GLOBAL_NAME, readProductDedupConfig, } from "../core/config.js";
import { estimatePairwiseEdges } from "./estimatePairwiseEdges.js";
import { loadDedupBrandBuckets } from "./loadDedupBrandBuckets.js";
export async function auditProductDuplicates(prisma) {
    ...
    const listingCountBySeller = new Map(listingCounts.map((row) => [row.sellerId.toString(), row._count]));
...
//# sourceMappingURL=auditProductDuplicates.js.map