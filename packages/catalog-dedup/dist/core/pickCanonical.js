export function casingScore(name) {
    let score = 0;
...
export function classifyDuplicateGroup(members) {
...
export function pickCanonicalBrand(members) {
...
export function pickDisplayBrandName(members, canonical) {
...
export function pickCanonicalProduct(members) {
    return [...members].sort((a, b) => {
        ...
        if (taxonomyB !== taxonomyA)
            return taxonomyB - taxonomyA;
        if (a.id < b.id)
            return -1;
        if (a.id > b.id)
            return 1;
...
export function orderUndirectedPair(productA, productB) {
    return productA < productB ? [productA, productB] : [productB, productA];
}
//# sourceMappingURL=pickCanonical.js.map